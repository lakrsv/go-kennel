...
func Simulate() {
	...
	kennel.Add(animal.NewAnimal("Hoofsworth", "Has a tendency to stampede", 10, 700.14, 0.055))
	kennel.Add(animal.NewAnimal("Purraloaf", "Shorter whiskers than most", 5, 550.124, 0.0325))
